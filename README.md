...
<H1 align="center">-== WTL (Windows To Linux) ==-</H1>

<p align="center" style="font-size: 15px">
    <b>Нахуя? Хз. Мне удобно</b>
</p>

<H2 align="center">-==[ How to ]==-</H2>

<p align="center" style="font-size: 15px">
    Создать папку "WindowsToLinux", создать .env с "ssh_host", "ssh_user", "ssh_key"
    <br>
    Отредачить "files.json" как вам уперлось.
    <br>
    Установить всё из "depentd.txt" (Я не делал автоустановку, бя)
    <br>
    Запустить init.py
    <br><br>
    <b>PROFIT!!!</b>
...
<H2 align="center">-==[ files.json example ]==-</H2>
...
<H2 align="center">-==[ .env example ]==-</H2>
